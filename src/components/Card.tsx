...
const Card: React.FC<CardProps> = ({ title, description, image, handleClick}) => {
  return (
    <div className="card flex flex-row md:flex-col bg-gray-300 md:px-10 md:py-8 rounded-[20px] mx-3 my-3 md:max-w-[300px] cursor-pointer" onClick={handleClick}>
      {image && (
